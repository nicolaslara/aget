...
export const fetch = tool({
  ...
  args: {
    ...
    backend_options: tool.schema
      .array(tool.schema.string())
      .optional()
      .describe("Optional unstable backend.key=value strings; the owned extractor currently supports crawl4ai.target_elements, crawl4ai.excluded_tags, crawl4ai.only_text, crawl4ai.delay_before_return_html, crawl4ai.page_timeout, and crawl4ai.wait_for_timeout."),
  },
