...
export const fetch = tool({
  ...
  args: {
    ...
    backend_options: tool.schema
      .array(tool.schema.string())
      .optional()
      .describe("Optional unstable backend.key=value strings; AgetExtractor currently supports crawl4ai.target_elements, crawl4ai.excluded_tags, crawl4ai.base_url, crawl4ai.exclude_all_images, crawl4ai.exclude_domains, crawl4ai.exclude_external_images, crawl4ai.exclude_external_links, crawl4ai.exclude_internal_links, crawl4ai.exclude_social_media_domains, crawl4ai.exclude_social_media_links, crawl4ai.only_text, crawl4ai.process_iframes, crawl4ai.remove_forms, crawl4ai.remove_overlay_elements, crawl4ai.keep_data_attributes, crawl4ai.word_count_threshold, crawl4ai.delay_before_return_html, crawl4ai.page_timeout, crawl4ai.wait_for_timeout, crawl4ai.wait_until=domcontentloaded|load|networkidle, crawl4ai.wait_for_images, crawl4ai.scan_full_page, crawl4ai.scroll_delay, crawl4ai.max_scroll_steps, crawl4ai.flatten_shadow_dom, crawl4ai.body_width, crawl4ai.bypass_tables, crawl4ai.close_quote, crawl4ai.default_image_alt, crawl4ai.emphasis_mark, crawl4ai.escape_backslash, crawl4ai.escape_dash, crawl4ai.escape_dot, crawl4ai.escape_plus, crawl4ai.escape_snob, crawl4ai.google_doc, crawl4ai.google_list_indent, crawl4ai.hide_strikethrough, crawl4ai.ignore_emphasis, crawl4ai.ignore_images, crawl4ai.images_as_html, crawl4ai.images_to_alt, crawl4ai.images_with_size, crawl4ai.ignore_links, crawl4ai.inline_links, crawl4ai.links_each_paragraph, crawl4ai.ignore_mailto_links, crawl4ai.ignore_tables, crawl4ai.include_sup_sub, crawl4ai.mark_code, crawl4ai.open_quote, crawl4ai.pad_tables, crawl4ai.protect_links, crawl4ai.single_line_break, crawl4ai.skip_internal_links, crawl4ai.strong_mark, crawl4ai.ul_item_mark, crawl4ai.unicode_snob, crawl4ai.use_automatic_links, crawl4ai.wrap_links, crawl4ai.wrap_list_items, and crawl4ai.wrap_tables."),
  },
