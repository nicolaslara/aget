...
export const fetch = tool({
  ...
  args: {
    ...
    backend_options: tool.schema
      .array(tool.schema.string())
      .optional()
      .describe("Optional unstable backend.key=value strings; AgetExtractor currently supports crawl4ai.target_elements, crawl4ai.excluded_tags, crawl4ai.base_url, crawl4ai.exclude_all_images, crawl4ai.exclude_domains, crawl4ai.exclude_external_images, crawl4ai.exclude_external_links, crawl4ai.exclude_internal_links, crawl4ai.exclude_social_media_domains, crawl4ai.exclude_social_media_links, crawl4ai.only_text, crawl4ai.process_iframes, crawl4ai.remove_forms, crawl4ai.remove_overlay_elements, crawl4ai.keep_data_attributes, crawl4ai.word_count_threshold, crawl4ai.delay_before_return_html, crawl4ai.page_timeout, crawl4ai.wait_for_timeout, crawl4ai.wait_until=domcontentloaded|load|networkidle, crawl4ai.wait_for_images, crawl4ai.scan_full_page, crawl4ai.scroll_delay, crawl4ai.max_scroll_steps, crawl4ai.flatten_shadow_dom, crawl4ai.include_sup_sub, and crawl4ai.skip_internal_links."),
  },
