...
- Recent follow-up slices D326-D332 add `crawl4ai.body_width`, `crawl4ai.mark_code`, `crawl4ai.single_line_break`, `crawl4ai.unicode_snob`, `crawl4ai.wrap_links`, and `crawl4ai.wrap_list_items` compatibility with source-backed caveats where owned defaults intentionally remain stable. `workpads/research/tasks.md` was not compacted.
