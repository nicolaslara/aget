...
- Current slice D326 adds `crawl4ai.body_width` with default unwrapped markdown, positive-width wrapping for plain paragraphs, structural markdown line preservation, command-helper forwarding, docs/schema alignment, and deterministic focused coverage. `workpads/research/tasks.md` was not compacted.
