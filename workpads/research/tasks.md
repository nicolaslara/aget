...
- Recent follow-up slices D326-D330 add `crawl4ai.body_width`, `crawl4ai.mark_code`, `crawl4ai.single_line_break`, and `crawl4ai.unicode_snob` compatibility with source-backed caveats where owned defaults intentionally remain stable. `workpads/research/tasks.md` was not compacted.
