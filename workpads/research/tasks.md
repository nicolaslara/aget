...
- Recent follow-up slices D326-D334 add `crawl4ai.body_width`, `crawl4ai.mark_code`, `crawl4ai.single_line_break`, `crawl4ai.unicode_snob`, `crawl4ai.wrap_links`, `crawl4ai.wrap_list_items`, `crawl4ai.wrap_tables`, and `crawl4ai.pad_tables` compatibility with source-backed caveats where owned defaults intentionally remain stable. `workpads/research/tasks.md` was not compacted.
