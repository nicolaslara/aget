...
- I19e remains open for broader rendered JavaScript parity, manual real logged-in profile/keychain smoke execution, and startup/error classification. Current wait/startup/evaluation-error/transport detail routes through D284, D287, D329, and D340-D349.
...
| Latest individual decisions | `archive/knowledge/current-decision-index.md` and per-decision files through `archive/knowledge/d349-invalid-binary-cdp-frames.md` |
