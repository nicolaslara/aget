...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D255 split owned extraction page pipeline helpers out of `src/extraction/owned/mod.rs`.
- I19e remains open for broader rendered JavaScript parity, manual real logged-in profile/keychain smoke execution, and still-fuller startup/error classification after D254 split shared mock-site support server helpers.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d255-owned-extraction-page-pipeline-split.md` |
