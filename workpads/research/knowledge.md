...
| Latest individual decisions | `archive/knowledge/current-decision-index.md` and per-decision files through `archive/knowledge/d367-remove-consent-popups-option.md` |
