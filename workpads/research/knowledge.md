...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness. Recent source-backed markdown option work is D293-D307; current-state detail routes through D308.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d308-workpad-support-routing.md` |
