...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D227 added source-backed `exclude_all_images` cleanup support.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d227-exclude-all-images-cleanup.md` |
