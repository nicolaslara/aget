...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D275 added source-backed `crawl4ai.process_iframes` CDP rendering support.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d276-page-scripts-split.md` |
