...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness. Recent source-backed markdown option work is D293-D307 plus D309-D311, D326-D328, D330-D339, D345, and D348; current-state detail routes through D308.
- I19e remains open for broader rendered JavaScript parity, manual real logged-in profile/keychain smoke execution, and startup/error classification. Current wait/startup/evaluation-error/transport detail routes through D284, D287, D329, and D340-D351.
...
| Latest individual decisions | `archive/knowledge/current-decision-index.md` and per-decision files through `archive/knowledge/d351-cdp-websocket-size-limits.md` |
