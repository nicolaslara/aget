...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D226 added source-backed `keep_data_attributes` cleanup support.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d226-keep-data-attributes-cleanup.md` |
