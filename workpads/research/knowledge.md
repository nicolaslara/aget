...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D251 split extraction pipeline finalization helpers out of `src/extraction/mod.rs`.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d252-module-decomposition-archive-split.md` |
