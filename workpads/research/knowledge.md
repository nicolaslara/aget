...
- Current support-file rule: do not compact `workpads/research/tasks.md`. Keep top-level support files as compact routers and move dense completed-history detail to referenced archive files; see D308, D347, D357, D364, and D376-D390.
...
| Latest individual decisions | `archive/knowledge/current-decision-index.md` and per-decision files through `archive/knowledge/d390-cleanup-assertion-split.md` |
