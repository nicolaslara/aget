...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D281 added source-backed generic page metadata propagation for owned and compatibility extraction.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d281-page-metadata.md` |
