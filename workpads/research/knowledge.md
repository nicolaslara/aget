...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D281 added source-backed generic page metadata propagation and D282 preserved it across owned browser fallback extraction.
- I19e remains open for broader rendered JavaScript parity, manual real logged-in profile/keychain smoke execution, and still-fuller startup/error classification after D283 strengthened source-backed networkidle reset/timeout coverage.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d283-cdp-networkidle-reset-timeout.md` |
