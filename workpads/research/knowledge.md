...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D278 added source-backed `crawl4ai.base_url` support for raw/local HTML link resolution.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d278-base-url-option.md` |
