...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D277 added source-backed local-content URL support for owned static extraction.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d277-local-content-urls.md` |
