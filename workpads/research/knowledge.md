...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D248 split the AgetExtractor mock-site route fixture by behavior without changing parity assertions.
- I19e remains open for broader rendered JavaScript parity, manual real logged-in profile/keychain smoke execution, and still-fuller startup/error classification after D247 split current-tab facade orchestration out of `src/aget/mod.rs`.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d248-aget-extractor-route-fixture-split.md` |
