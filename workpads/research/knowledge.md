...
| Owned backend feature slices | `archive/knowledge/d077-d122-owned-backend-slices.md` index to `d077-d091-owned-extractor-options-cleanup.md`, `d092-d108-markdown-browser-slices.md` index to section files, and `d109-d122-selector-overlay-shadow.md` |
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d271-engine-refactor-plan-split.md` |
