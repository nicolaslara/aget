...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d209-aget-browser-current-tab-engine.md` |
...
- Which public consent and command/API shape should expose the owned current-tab engine now available behind an explicit local debugging-port seam?
