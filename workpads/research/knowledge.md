...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness. Recent source-backed markdown/readability work is D293-D307 plus D309-D311, D326-D328, D330-D339, D345, D348, D355-D356, and D358; current-state detail routes through D308.
...
| Latest individual decisions | `archive/knowledge/current-decision-index.md` and per-decision files through `archive/knowledge/d358-preserve-tags-markdown-option.md` |
