...
- I19d remains open for full Crawl4AI-quality readability/markdown and still-richer rendered-page readiness after D281 added source-backed generic page metadata propagation, D282 preserved it across owned browser fallback extraction, and D285 aligned agent-facing option docs with the owned extractor surface.
...
| Latest individual decisions | `archive/knowledge/d168-workpad-knowledge-compaction.md` through `archive/knowledge/d285-agent-facing-option-docs.md` |
