...
const FORWARDED_CRAWL4AI_OPTIONS: &[&str] = &[
    "crawl4ai.base_url=https://docs.example/raw/",
    "crawl4ai.cache=bypass",
    "crawl4ai.cache_mode=disabled",
    ...
    "crawl4ai.css_selector=main.article",
    ...
    "crawl4ai.excluded_selector=aside,.promo",
    "crawl4ai.remove_consent_popups=true",
    "crawl4ai.remove_overlay_elements=false",
    "crawl4ai.keep_attrs=aria-label,rel",
    "crawl4ai.prettiify=true",
    "crawl4ai.process_in_browser=true",
    "crawl4ai.user_agent=aget-test/2.0",
    "crawl4ai.locale=sv-SE",
    "crawl4ai.timezone_id=Europe/Stockholm",
...
fn get_command_backend_accepts_scan_full_page_options() {
    ...
    let fake_backend = mock_backend_command(
        ...
        json!({
            ...
            "expect_extractor_options": FORWARDED_CRAWL4AI_OPTIONS
        }),
    );
    ...
    for option in FORWARDED_CRAWL4AI_OPTIONS {
