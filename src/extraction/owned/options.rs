...
pub(crate) struct OwnedExtractorOptions {
    ...
    pub(crate) preserve_tags: Vec<String>,
    pub(crate) handle_code_in_pre: bool,
    pub(crate) ignore_emphasis: bool,
    pub(crate) ignore_links: bool,
    pub(crate) inline_links: bool,
    pub(crate) links_each_paragraph: bool,
    ...
    pub(crate) google_doc: bool,
    pub(crate) google_list_indent: usize,
    ...
    pub(crate) escape_dot: bool,
    pub(crate) escape_plus: bool,
    pub(crate) escape_dash: bool,
    ...
    pub(crate) process_in_browser: bool,
